...
public class CreateSteps extends SessionBean {
    ...
    public CreateSteps() {
        ...
        System.out.println("I am in CreateSteps");
        ...
        // If there is an edit page
        if (getRequest("action") != null || getSession().getAttribute("action") != null) {

            if (getRequest("action") != null) {
                getSession().setAttribute("action", "edit");
            }
            ...
            for (int i = 0; i < as.getAssistentStepClasses().size(); i++) {
                try {
                    CreateStepClasses csc = new CreateStepClasses(
                            ((AssistentStepClass) as.getAssistentStepClasses().get(i)).getIdStepClass());
                    classList.add(csc);
            ...
            this.countClasses = this.classes.getRowCount();
    ...
    public String getStepTitle() {
        //System.out.println("I am in get step title");
    ...
    public void mountStep() {
        ...
        if (this.getSelectedClasses().length == 0)
            setErrorMsg(Constant.CREATE_STEPS_MSG1);
        else {
    ...
    private void saveNewAssistent() {
        ...
        ca.save();
        System.out.println("I am in save new assistant");
    }
    ...
    public String backAndCancel() {
        //System.out.println("I am in back and cancel 2");
        getSession().removeAttribute("action");
    ...
    public void myButton() {
        System.out.println("I am in createbeans my button");
            ...
            if (orderClasses.contains(csc.getNumOrderAppear())) {
                ...
                for (int j=0; j<csc.getProperties().getRowCount(); j++) {
                    ...
                    if (properties.contains(cscp.getNumOrderAppear())) {
                        ...
                        cscp.getNumOrderAppear() + Constant.ADD_KNOWLEDGE_MSG3 +

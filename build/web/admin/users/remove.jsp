...
<f:view>   
    ...
    <h:panelGrid columns="1" headerClass="tituloBox" styleClass="boxCorpoPagina" 
        ...
        <h:dataTable id="users1" columnClasses="list-column-four, list-column-three, 
                     list6-column-one, list-column-three, list-column-three" 
            ...
            <h:column>
                ...
                <h:outputLink 
                    value="#{facesContext.externalContext.requestContextPath}/admin/users/delete.jsf">
    ...
    <h:panelGrid columns="1" headerClass="tituloBox" styleClass="boxCorpoPagina" 
        ...
        <h:dataTable id="users2" columnClasses="list-column-four, list-column-three, 
                     list6-column-one, list-column-three, list-column-three" 
                     headerClass="list-header" rowClasses="list-row" 

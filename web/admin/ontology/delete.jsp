...
<f:view>   
    ...
    <h:panelGrid columns="1" headerClass="boxTituloPagina" 
        ...
        <f:facet name="header">
            <h:outputText id="pageTitle" value="#{msgs.ontologyDeletePageTitleMsg1}" 
    ...
    <h:panelGrid columns="1" headerClass="boxTituloPagina" 
                 styleClass="boxCorpoPagina">
        <h:form>
            <h:outputText styleClass="textoForm1" value=" #{msgs.deleteTextoForm1Msg1} #{ontologyViewBean.ontName}."/>
            ...
            <h:commandButton value="#{msgs.deleteYesMsg1}" action="#{addOntologyBean.removeOntology}"/>
            <h:commandButton value="#{msgs.deleteNoMsg1}" action="#{addOntologyBean.back}"/>
        </h:form>
    </h:panelGrid>
</f:view>

...
<f:view>
    ...
    <h:form id="edit_knowledge">
        <h:panelGrid columns="1" headerClass="boxTituloPagina" 
                     styleClass="boxCorpoPagina">
            <f:facet name="header">
                <h:outputText id="pageTitle" value="#{msgs.knwEdt_pageTitle}" 
            ...
            <h:panelGrid columns="1" width="100%" align="center">          
                <h:message for="edit_knowledge" styleClass="erro_form"/>
            ...
            <h:commandButton id="cmb_entrar" value="#{msgs.saveAltButton}" 
                             styleClass="botao" 
                             action="#{addKnowledgeBean.updateThis}"/>
